<?php include('includes/header.php'); ?>
 <title>CollageMe - Register</title>  
</head>
<?php include('includes/nav.php'); ?>
<div class="row py-5" style="background:linear-gradient(to bottom, #08070e 0%, #08070e 100%, rgba(8,7,14,0) 100% ) no-repeat;">
    <div class="col-10 col-lg-4 col-md-4 mx-auto mt-7 bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
  <div class="p-4 sm:p-7">
    ...
    <div class="mt-5">
      ...
      <!-- Form -->
      <form action="./includes/crud.php?c=83483264983294863846" method="post">
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <p class="hidden text-xs text-red-600 mt-2" id="name-error">Please include a valid name address so we can get back to you</p>
          </div>
          <!-- End Form Group -->
          ...
          <!-- End Form Group -->
           <!-- Form Group -->
          <div>
            <label for="phone" class="block text-sm mb-2 dark:text-white">Mobile Number</label>
            <div class="relative">
              <select name="mobile_code" class="py-2.5 sm:py-3 px-4 block d-inline border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                <option value="+1">+1</option>
                <option value="+44">+44</option>
              </select>
              <input type="tel" id="phone" name="phone" class="py-2.5 sm:py-3 px-4 block d-inline border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="phone-error">
              <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                </svg>
            ...
            <p class="hidden text-xs text-red-600 mt-2" id="phone-error">Please include a valid phone address so we can get back to you</p>
          </div>
          <!-- End Form Group -->
          ...
          <div>
            ...
            <div class="relative">
              <input type="password" id="confirm-password" name="password_confirmation" class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" required aria-describedby="confirm-password-error">
              <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                </svg>
